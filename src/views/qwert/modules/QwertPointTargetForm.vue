  ...
  <a-spin :spinning="confirmLoading">
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        ...
        <!--      <a-input v-model="model.devType" placeholder="请输入设备类型"  ></a-input> -->
              <j-tree-select
                ref="treeSelect"
                placeholder="请输入设备分类"
      ...
      <!--        <a-input v-model="model.infoType" placeholder="请输入信息点类型"  ></a-input> -->
          ...
          <a-col :span="8">
            <a-form-model-item label="点数值类型" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="infoDatatype">
              <a-input v-model="model.infoDatatype" placeholder="请输入信息点数值类型"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="8">
            <a-form-model-item label="点数值精度" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="infoDataaccurate">
              <a-input v-model="model.infoDataaccurate" placeholder="请输入信息点数值精度"  ></a-input>
            </a-form-model-item>
          </a-col>
